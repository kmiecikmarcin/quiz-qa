...
Scenario: LOGIN_MODULE_[/quiz/users/login]_[POST]_2_send request_with_empty_data
...
Scenario Outline: LOGIN_MODULE_[/quiz/users/login]_[POST]_3_send_request_with_incorrect_<field>
