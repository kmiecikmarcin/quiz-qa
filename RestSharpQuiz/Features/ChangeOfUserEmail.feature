Feature: Change of user email

Background: 
	Given User signs up in system
	And User signs in
	
Scenario: CHANGE_OF_USER_EMAIL_1_[/quiz/users/email]_[PUT]_send_request_with_correct_email_and_password
...
Scenario: CHANGE_OF_USER_EMAIL_2_[/quiz/users/email]_[PUT]_send_request_with_email_which_is_assigned_to_account
...
Scenario: CHANGE_OF_USER_EMAIL_3_[/quiz/users/email]_[PUT]_send_request_with_password_which_is_not_assigned_to_account
	Given User filled password which is incorrect
	When Request sends to API 
	Then The server should return status 400
	And Response with message about password

Scenario Outline: CHANGE_OF_USER_EMAIL_4_[/quiz/users/email]_[PUT]_send_request_with_incorrect_email
...
Scenario Outline: CHANGE_OF_USER_EMAIL_5_[/quiz/users/email]_[PUT]_send_request_with_incorrect_password
