...
Scenario: CHANGE_OF_USER_EMAIL_1_[/quiz/users/email]_[PUT]_send_request_with_correct_email
	Given User filled correctly email
...
Scenario Outline: CHANGE_OF_USER_EMAIL_3_[/quiz/users/email]_[PUT]_send_request_with_incorrect_email
